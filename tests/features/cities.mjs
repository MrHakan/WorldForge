...
for(const f of ['src/core/engine.js','src/core/history-engine.js','src/core/society-engine.js','src/features/city/city-engine.js'])vm.runInThisContext(fs.readFileSync(f,'utf8'),{filename:f});
