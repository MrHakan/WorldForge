...
for(const f of ['src/core/engine.js','src/core/history-engine.js','src/core/society-engine.js','src/features/city/city-engine.js','src/features/adventure/adventure-engine.js','src/features/story/story-engine.js','src/features/wiki/wiki-engine.js'])vm.runInThisContext(fs.readFileSync(f,'utf8'),{filename:f});
