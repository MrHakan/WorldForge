...
vm.runInThisContext(fs.readFileSync('src/core/engine.js','utf8'),{filename:'src/core/engine.js'});
vm.runInThisContext(fs.readFileSync('src/core/history-engine.js','utf8'),{filename:'src/core/history-engine.js'});
vm.runInThisContext(fs.readFileSync('src/core/society-engine.js','utf8'),{filename:'src/core/society-engine.js'});
