...
vm.runInThisContext(fs.readFileSync('src/features/warfare/warfare-battlefield-history-v2.js','utf8'),{filename:'src/features/warfare/warfare-battlefield-history-v2.js'});
