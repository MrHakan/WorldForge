...
vm.runInThisContext(fs.readFileSync('src/features/warfare/warfare-strategic-reserves.js','utf8'),{filename:'src/features/warfare/warfare-strategic-reserves.js'});
